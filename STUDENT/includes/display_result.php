        ...
        window.onload = function() {
            if (typeof history.pushState === "function") {
                ...
                window.addEventListener('popstate', function () {
                    history.pushState(null, null, document.URL);
                    window.location.href = 'assessment_viewinfo.php'; 
                });
            }
        };
    ...
    <div class="content-body">
        <div class="container body-container">
            <div class="content-block">
                <h1 style="text-align: center;">Assessment Result</h1>
                <p id="score"></p>
                <p id="grade"></p>
                <div class="button-container">
                    <a href="../landing_page.php" class="button red">Go to Assessment Page</a>
                    <a id="assessment-info-link" class="button red">Go to Assessment Info</a>
                </div>
            </div>
        </div>
    </div>
