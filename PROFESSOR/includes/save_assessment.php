...
if ($stmt->execute()) {
    ...
    $insertAnswerSql = "INSERT INTO EXAM_ANSWER (assessment_ID, question_ID, answer, m_Ans1, m_Ans2, m_Ans3, m_Ans4, m_Ans5, m_Ans6, m_Ans7, m_Ans8, m_Ans9, m_Ans10, long_Answer) 
                        VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
    ...
    if (is_array($questions)) {
        foreach ($questions as $index => $question) {
            ...
            $stmtInsertAnswer->bind_param('sissssssssssss', $assessmentID, $questionID, $correctAnswer, $m_Ans1, $m_Ans2, $m_Ans3, $m_Ans4, $m_Ans5, $m_Ans6, $m_Ans7, $m_Ans8, $m_Ans9, $m_Ans10, $longAnswer);
